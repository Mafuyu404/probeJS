...
declare namespace Internal {
    class LaserPointerItem extends Internal.Item {
        constructor()
        ...
        */
        ...
        static getLaserColorARGB(arg0: number): number;
    ...
    type LaserPointerItem_ = LaserPointerItem;
    ...
    class HookModifier extends Internal.Enum<Internal.HookModifier> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        getTranslationKey(): string;
        static values(): Internal.HookModifier[];
        "compareTo(org.li64.tide.data.rods.HookModifier)"(arg0: Internal.HookModifier_): number;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        isLavaproof(): boolean;
        name(): string;
        compareTo(arg0: Internal.HookModifier_): number;
        hashCode(): number;
        getTextureLocation(): ResourceLocation;
        ordinal(): number;
        wait(): void;
        static valueOf(arg0: string): Internal.HookModifier;
        getItem(): Internal.Item;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.HookModifier>>;
        getDeclaringClass(): typeof Internal.HookModifier;
        get class(): typeof any
        get translationKey(): string
        get lavaproof(): boolean
        get textureLocation(): ResourceLocation
        get item(): Internal.Item
        get declaringClass(): typeof Internal.HookModifier
        static readonly NORMAL: (Internal.HookModifier) & (Internal.HookModifier);
        static readonly IRON: (Internal.HookModifier) & (Internal.HookModifier);
        static readonly LAVAPROOF: (Internal.HookModifier) & (Internal.HookModifier);
    }
    type HookModifier_ = "normal" | HookModifier | "iron" | "lavaproof";
    class Seed {
    ...
    interface VillagerLike <E extends Internal.Entity & Internal.VillagerLike<E>> extends Internal.CTrackedEntity<E>, Internal.VillagerDataHolder, Internal.Infectable, Internal.Messenger {
        sendChatMessage(message: Internal.MutableComponent_, receiver: Internal.Entity_): Internal.MutableComponent;
        validateClothes(): void;
        sendEventMessage(message: net.minecraft.network.chat.Component_, receiver: Internal.Player_): void;
        randomizeClothes(): void;
        abstract getVillagerData(): Internal.VillagerData;
        getTranslatable(target: Internal.Player_, phraseId: string, ...params: any[]): Internal.MutableComponent;
        sendChatMessage(target: Internal.Player_, phraseId: string, ...params: any[]): void;
        getHair(): string;
        getProfessionId(): ResourceLocation;
        isToYoungToSpeak(): boolean;
        getPlayerModel(): Internal.VillagerLike$PlayerModel;
        getProfessionText(): Internal.MutableComponent;
        setName(name: string): void;
        randomizeHair(): void;
        canBeAttractedTo(other: Internal.PlayerSaveData_): boolean;
        canBeAttractedTo(other: Internal.VillagerLike_<any>): boolean;
        sendEventMessage(message: net.minecraft.network.chat.Component_): void;
        toVillager(entity: Internal.Entity_): Internal.VillagerLike<any>;
        getRawScaleFactor(): number;
        spawnBurntParticles(): void;
        clearHairDye(): void;
        sendEventMessage(world: Internal.Level_, message: net.minecraft.network.chat.Component_): void;
        "setVariant(java.lang.Object)"(arg0: any): void;
        getHorizontalScaleFactor(): number;
        getDominantSlot(): Internal.EquipmentSlot;
        "toVillager(forge.net.mca.server.world.data.PlayerSaveData)"(player: Internal.PlayerSaveData_): Internal.VillagerLike<any>;
        setClothes(clothes: string): void;
        initializeSkin(isPlayer: boolean): void;
        setHair(hair: ResourceLocation_): void;
        isProfessionImportant(): boolean;
        "toVillager(net.minecraft.world.entity.Entity)"(entity: Internal.Entity_): Internal.VillagerLike<any>;
        "setHair(java.lang.String)"(hair: string): void;
        setCustomSkin(name: string): void;
        asEntity(): Internal.Mob;
        "sendEventMessage(net.minecraft.network.chat.Component,net.minecraft.world.entity.player.Player)"(message: net.minecraft.network.chat.Component_, receiver: Internal.Player_): void;
        "setClothes(net.minecraft.resources.ResourceLocation)"(clothes: ResourceLocation_): void;
        toVillager(player: Internal.PlayerSaveData_): Internal.VillagerLike<any>;
        ...
        getDialogueType(receiver: Internal.Player_): Internal.DialogueType;
        getGameProfile(): Internal.GameProfile;
        "canBeAttractedTo(forge.net.mca.server.world.data.PlayerSaveData)"(other: Internal.PlayerSaveData_): boolean;
        createTrackedData<E extends Internal.Entity>(type: E): Internal.CDataManager$Builder<E>;
        getClothes(): string;
        hasCustomSkin(): boolean;
        setHairDye(color: Internal.DyeColor_): void;
        getOpposingSlot(): Internal.EquipmentSlot;
        initialize(spawnReason: Internal.MobSpawnType_): void;
        getDominantHand(): Internal.InteractionHand;
        "setVariant(net.minecraft.world.entity.npc.VillagerType)"(arg0: Internal.VillagerType_): void;
        sendChatToAllAround(phrase: Internal.MutableComponent_): void;
        getProfessionName(): string;
        getVariant(): any;
        abstract getInfectionProgress(): number;
        "canBeAttractedTo(forge.net.mca.entity.VillagerLike)"(other: Internal.VillagerLike_<any>): boolean;
        setAgeState(state: Internal.AgeState_): boolean;
        abstract getVillagerBrain(): Internal.VillagerBrain<any>;
        abstract getGenetics(): Internal.Genetics;
        isHostile(): boolean;
        getAttractedGenderSet(villager: Internal.VillagerLike_<any>): Internal.Set<Internal.Gender>;
        "sendEventMessage(net.minecraft.world.level.Level,net.minecraft.network.chat.Component)"(world: Internal.Level_, message: net.minecraft.network.chat.Component_): void;
        readNbtForConversion(convertingFrom: Internal.EntityType_<any>, input: Internal.CompoundTag_): void;
        abstract setInfectionProgress(arg0: number): void;
        "setHair(net.minecraft.resources.ResourceLocation)"(hair: ResourceLocation_): void;
        getHairDye(): number[];
        abstract getTypeDataManager(): Internal.CDataManager<E>;
        setTrackedValue<P, TrackedP>(key: Internal.CParameter_<P, TrackedP>, value: P): void;
        getOpposingHand(): Internal.InteractionHand;
        isInfected(): boolean;
        isSpeechImpaired(): boolean;
        getTrackedValue<P, TrackedP>(key: Internal.CParameter_<P, TrackedP>): P;
        setHairDye(r: number, g: number, b: number): void;
        getVillagerDimensions(): Internal.VillagerDimensions;
        abstract getTraits(): Internal.Traits;
        setInfected(infected: boolean): void;
        transformMessage(message: Internal.MutableComponent_): Internal.MutableComponent;
        abstract getInteractions(): Internal.EntityCommandHandler<any>;
        toNbtForConversion(convertingTo: Internal.EntityType_<any>): Internal.CompoundTag;
        getSlotForHand(hand: Internal.InteractionHand_): Internal.EquipmentSlot;
        "setClothes(java.lang.String)"(clothes: string): void;
        getAgeState(): Internal.AgeState;
        canTradeWithProfession(): boolean;
        abstract isBurned(): boolean;
        updateSpeed(): void;
        setHair(hair: string): void;
        copyVillagerAttributesFrom(other: Internal.VillagerLike_<any>): void;
        requiresHome(): boolean;
        setVariant(arg0: any): void;
        setClothes(clothes: ResourceLocation_): void;
        playSpeechEffect(): void;
        get villagerData(): Internal.VillagerData
        get hair(): string
        get professionId(): ResourceLocation
        get toYoungToSpeak(): boolean
        get playerModel(): Internal.VillagerLike$PlayerModel
        get professionText(): Internal.MutableComponent
        set name(name: string)
        get rawScaleFactor(): number
        set "variant(java.lang.Object)"(arg0: any)
        get horizontalScaleFactor(): number
        get dominantSlot(): Internal.EquipmentSlot
        set clothes(clothes: string)
        set hair(hair: ResourceLocation_)
        get professionImportant(): boolean
        set "hair(java.lang.String)"(hair: string)
        set customSkin(name: string)
        set "clothes(net.minecraft.resources.ResourceLocation)"(clothes: ResourceLocation_)
        set variant(arg0: Internal.VillagerType_)
        set villagerData(arg0: Internal.VillagerData_)
        get gameProfile(): Internal.GameProfile
        get clothes(): string
        set hairDye(color: Internal.DyeColor_)
        get opposingSlot(): Internal.EquipmentSlot
        get dominantHand(): Internal.InteractionHand
        set "variant(net.minecraft.world.entity.npc.VillagerType)"(arg0: Internal.VillagerType_)
        get professionName(): string
        get variant(): any
        get infectionProgress(): number
        set ageState(state: Internal.AgeState_)
        get villagerBrain(): Internal.VillagerBrain<any>
        get genetics(): Internal.Genetics
        get hostile(): boolean
        set infectionProgress(arg0: number)
        set "hair(net.minecraft.resources.ResourceLocation)"(hair: ResourceLocation_)
        get hairDye(): number[]
        get typeDataManager(): Internal.CDataManager<E>
        get opposingHand(): Internal.InteractionHand
        get infected(): boolean
        get speechImpaired(): boolean
        get villagerDimensions(): Internal.VillagerDimensions
        get traits(): Internal.Traits
        set infected(infected: boolean)
        get interactions(): Internal.EntityCommandHandler<any>
        set "clothes(java.lang.String)"(clothes: string)
        get ageState(): Internal.AgeState
        get burned(): boolean
        set hair(hair: string)
        set variant(arg0: any)
        set clothes(clothes: ResourceLocation_)
        readonly HAIR_COLOR_RED: Internal.CDataParameter<number>;
        readonly CLOTHES: Internal.CDataParameter<string>;
        readonly HAIR: Internal.CDataParameter<string>;
        readonly CUSTOM_SKIN: Internal.CDataParameter<string>;
        readonly VILLAGER_NAME: Internal.CDataParameter<string>;
        readonly AGE_STATE: Internal.CEnumParameter<Internal.AgeState>;
        readonly HAIR_COLOR_BLUE: Internal.CDataParameter<number>;
        readonly HAIR_COLOR_GREEN: Internal.CDataParameter<number>;
        readonly SPEED_ID: (Internal.UUID) & (Internal.UUID);
    }
    type VillagerLike_<E extends Internal.Entity & Internal.VillagerLike<E>> = VillagerLike<E>;
    ...
    class BaconAndEggCupItem extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type BaconAndEggCupItem_ = BaconAndEggCupItem;
    class Genetics implements Internal.Iterable<Internal.Genetics$Gene> {
        constructor(entity: Internal.VillagerLike_<any>)
        getClass(): typeof any;
        getGenome(type: Internal.Genetics$GeneType_): Internal.Genetics$Gene;
        toString(): string;
        getVerticalScaleFactor(): number;
        setGene(type: Internal.Genetics$GeneType_, value: number): void;
        notifyAll(): void;
        forEach(arg0: Internal.Consumer_<Internal.Genetics$Gene>): void;
        combine(mother: Internal.Genetics_, father: Internal.Genetics_): void;
        setGender(gender: Internal.Gender_): void;
        notify(): void;
        getHorizontalScaleFactor(): number;
        wait(arg0: number, arg1: number): void;
        getGender(): Internal.Gender;
        iterator(): Internal.Iterator<Internal.Genetics$Gene>;
        hashCode(): number;
        combine(mother: Internal.Genetics_, father: Internal.Genetics_, seed: number): void;
        randomize(): void;
        wait(): void;
        static createTrackedData<E extends Internal.Entity>(builder: Internal.CDataManager$Builder_<E>): Internal.CDataManager$Builder<E>;
        wait(arg0: number): void;
        getGene(type: Internal.Genetics$GeneType_): number;
        spliterator(): Internal.Spliterator<Internal.Genetics$Gene>;
        equals(arg0: any): boolean;
        getBreastSize(): number;
        get class(): typeof any
        get verticalScaleFactor(): number
        set gender(gender: Internal.Gender_)
        get horizontalScaleFactor(): number
        get gender(): Internal.Gender
        get breastSize(): number
        static readonly HEMOGLOBIN: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly VOICE_TONE: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly VOICE: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly WIDTH: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly EUMELANIN: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly MELANIN: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly SIZE: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly PHEOMELANIN: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly FACE: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly BREAST: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
        static readonly SKIN: (Internal.Genetics$GeneType) & (Internal.Genetics$GeneType);
    }
    type Genetics_ = Genetics;
    class ZaniteSwordItem extends Internal.SwordItem implements Internal.ZaniteWeapon {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        ...
        */
        getMaxDamage(): number;
        removeAttribute(attribute: Internal.Attribute_, uuid: Internal.UUID_): void;
        increaseDamage(arg0: Internal.Multimap_<Internal.Attribute, Internal.AttributeModifier>, arg1: Internal.ItemStack_, arg2: Internal.EquipmentSlot_): Internal.Multimap<Internal.Attribute, Internal.AttributeModifier>;
        getDescription(): net.minecraft.network.chat.Component;
        /**
         * @deprecated
        */
    ...
    type ZaniteSwordItem_ = ZaniteSwordItem;
    ...
    class DefaultDispenseItemBehavior implements Internal.DispenseItemBehavior, Internal.DefaultDispenseItemBehaviorInvoker {
        constructor()
        getClass(): typeof any;
        ...
        equals(arg0: any): boolean;
        invokeExecute(arg0: Internal.BlockSource_, arg1: Internal.ItemStack_): Internal.ItemStack;
        get class(): typeof any
    }
    ...
    class DryingRackBlock extends Internal.BaseEntityBlock {
        ...
        */
        ...
        stepOn(arg0: Internal.Level_, arg1: BlockPos_, arg2: Internal.BlockState_, arg3: Internal.Entity_): void;
        getPistonPushReaction(arg0: Internal.BlockState_): Internal.PushReaction;
        static buildModel(arg0: Internal.DataGenContext_<Internal.Block, Internal.DryingRackBlock>, arg1: Internal.RegistrateBlockstateProvider_): void;
        getExpDrop(arg0: Internal.BlockState_, arg1: Internal.LevelReader_, arg2: Internal.RandomSource_, arg3: BlockPos_, arg4: number, arg5: number): number;
        triggerEvent(arg0: Internal.BlockState_, arg1: Internal.Level_, arg2: BlockPos_, arg3: number, arg4: number): boolean;
        /**
         * @deprecated
    ...
    class SmokedHamOmeletEggPanTrayBlock extends Internal.Block implements Internal.SimpleWaterloggedBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    type SmokedHamOmeletEggPanTrayBlock_ = SmokedHamOmeletEggPanTrayBlock;
    ...
    class DoorMatItem extends Internal.BlockItem {
    ...
    class MandrakeEffect extends Internal.EmptyEffect {
    ...
    type MandrakeEffect_ = MandrakeEffect;
    interface Remapper {
    ...
    class Climate$Sampler extends Internal.Record implements Internal.TBClimateSampler, Internal.MultiNoiseSamplerHooks, Internal.RTFClimateSampler {
        ...
        getUniqueness(): Internal.DensityFunction;
        setSpawnSearchCenter(spawnSearchCenter: BlockPos_): void;
        notify(): void;
        continentalness(): Internal.DensityFunction;
        wait(arg0: number, arg1: number): void;
        getSpawnSearchCenter(): BlockPos;
        temperature(): Internal.DensityFunction;
        humidity(): Internal.DensityFunction;
        handler$eln000$sample(i: number, j: number, k: number, callback: Internal.CallbackInfoReturnable_<any>, l: number, m: number, n: number, ctx: Internal.DensityFunction$SinglePointContext_): void;
        fabric_getEndBiomesSampler(): Internal.ImprovedNoise;
        toString(): string;
        setUniqueness(uniqueness: Internal.DensityFunction_): void;
        notifyAll(): void;
        ...
        get class(): typeof any
        get uniqueness(): Internal.DensityFunction
        set spawnSearchCenter(spawnSearchCenter: BlockPos_)
        get spawnSearchCenter(): BlockPos
        set uniqueness(uniqueness: Internal.DensityFunction_)
    }
    ...
    class BedrockGunModel extends Internal.BedrockAnimatedModel {
        constructor(arg0: any_, arg1: any_)
        getClass(): typeof any;
        getRefitAttachmentViewPath(arg0: Internal.AttachmentType_): Internal.List<Internal.BedrockPart>;
        getFixedOriginPath(): Internal.List<Internal.BedrockPart>;
        setFunctionalRenderer(arg0: string, arg1: Internal.Function_<Internal.BedrockPart, Internal.IFunctionalRenderer>): void;
        getGroundOriginPath(): Internal.List<Internal.BedrockPart>;
        getConstraintPath(): Internal.List<Internal.BedrockPart>;
        getIdleSightPath(): Internal.List<Internal.BedrockPart>;
        getNode(arg0: string): Internal.BedrockPart;
        notify(): void;
        getRootNode(): Internal.BedrockPart;
        wait(arg0: number, arg1: number): void;
        delegateRender(arg0: Internal.IFunctionalRenderer_): void;
        getRenderHand(): boolean;
        render(arg0: Internal.PoseStack_, arg1: Internal.ItemDisplayContext_, arg2: Internal.RenderType_, arg3: number, arg4: number): void;
        getScopePosPath(): Internal.List<Internal.BedrockPart>;
        cleanAnimationTransform(): void;
        supplyListeners(arg0: string, arg1: Internal.ObjectAnimationChannel$ChannelType_): Internal.AnimationListener;
        getCurrentGunItem(): Internal.ItemStack;
        toString(): string;
        getBone(arg0: string): Internal.BonesItem;
        notifyAll(): void;
        getThirdPersonHandOriginPath(): Internal.List<Internal.BedrockPart>;
        cleanCameraAnimationTransform(): void;
        render(arg0: Internal.PoseStack_, arg1: Internal.ItemDisplayContext_, arg2: Internal.RenderType_, arg3: number, arg4: number, arg5: number, arg6: number, arg7: number, arg8: number): void;
        setTextShowList(arg0: Internal.Map_<string, Internal.TextShow>): void;
        getSize(): Internal.Vec2;
        getOffset(): Vec3d;
        render(arg0: Internal.PoseStack_, arg1: Internal.ItemStack_, arg2: Internal.ItemDisplayContext_, arg3: Internal.RenderType_, arg4: number, arg5: number): void;
        hashCode(): number;
        getCurrentAttachmentItem(): Internal.EnumMap<Internal.AttachmentType, Internal.ItemStack>;
        getConstraintObject(): Internal.ConstraintObject;
        wait(): void;
        getIronSightPath(): Internal.List<Internal.BedrockPart>;
        getIndexBones(): Internal.HashMap<string, Internal.BonesItem>;
        wait(arg0: number): void;
        getMuzzleFlashPosPath(): Internal.List<Internal.BedrockPart>;
        getCameraAnimationObject(): Internal.CameraAnimationObject;
        getShouldRender(): Internal.List<Internal.BedrockPart>;
        equals(arg0: any): boolean;
        setRenderHand(arg0: boolean): void;
        getAdditionalMagazineNode(): Internal.BedrockPart;
        get class(): typeof any
        get fixedOriginPath(): Internal.List<Internal.BedrockPart>
        get groundOriginPath(): Internal.List<Internal.BedrockPart>
        get constraintPath(): Internal.List<Internal.BedrockPart>
        get idleSightPath(): Internal.List<Internal.BedrockPart>
        get rootNode(): Internal.BedrockPart
        get renderHand(): boolean
        get scopePosPath(): Internal.List<Internal.BedrockPart>
        get currentGunItem(): Internal.ItemStack
        get thirdPersonHandOriginPath(): Internal.List<Internal.BedrockPart>
        set textShowList(arg0: Internal.Map_<string, Internal.TextShow>)
        get size(): Internal.Vec2
        get offset(): Vec3d
        get currentAttachmentItem(): Internal.EnumMap<Internal.AttachmentType, Internal.ItemStack>
        get constraintObject(): Internal.ConstraintObject
        get ironSightPath(): Internal.List<Internal.BedrockPart>
        get indexBones(): Internal.HashMap<string, Internal.BonesItem>
        get muzzleFlashPosPath(): Internal.List<Internal.BedrockPart>
        get cameraAnimationObject(): Internal.CameraAnimationObject
        get shouldRender(): Internal.List<Internal.BedrockPart>
        set renderHand(arg0: boolean)
        get additionalMagazineNode(): Internal.BedrockPart
    }
    type BedrockGunModel_ = BedrockGunModel;
    ...
    interface RTFMinecraftServer {
        abstract getFeatureTemplateManager(): Internal.FeatureTemplateManager;
        get featureTemplateManager(): Internal.FeatureTemplateManager
        (): Internal.FeatureTemplateManager_;
    }
    type RTFMinecraftServer_ = RTFMinecraftServer | (()=> Internal.FeatureTemplateManager_);
    ...
    class DyeBottleItem extends Internal.Item {
        ...
        isFireResistant(): boolean;
        getEnchantmentValue(arg0: Internal.ItemStack_): number;
        appendHoverText(stack: Internal.ItemStack_, level: Internal.Level_, list: Internal.List_<net.minecraft.network.chat.Component>, isAdvanced: Internal.TooltipFlag_): void;
        /**
         * @deprecated
        */
        getFoodProperties(): Internal.FoodProperties;
    ...
    class FleshTendonFeature extends Internal.Feature<Internal.NoneFeatureConfiguration> {
        ...
        wait(arg0: number, arg1: number): void;
        place(arg0: Internal.FeaturePlaceContext_<Internal.NoneFeatureConfiguration>): boolean;
        placeFleshTendonColumn(arg0: Internal.WorldGenLevel_, arg1: Internal.RandomSource_, arg2: BlockPos_): void;
        static isGrassOrDirt(arg0: Internal.LevelSimulatedReader_, arg1: BlockPos_): boolean;
        hashCode(): number;
        wait(): void;
        generateFleshBall(arg0: Internal.WorldGenLevel_, arg1: BlockPos_, arg2: Internal.RandomSource_): boolean;
        wait(arg0: number): void;
        static isDirt(arg0: Internal.BlockState_): boolean;
        setBlock(arg0: Internal.WorldGenLevel_, arg1: BlockPos_, arg2: Internal.BlockState_, arg3: number): boolean;
        equals(arg0: any): boolean;
        static isReplaceable(arg0: Internal.TagKey_<Internal.Block>): Internal.Predicate<Internal.BlockState>;
        configuredCodec(): Internal.Codec<Internal.ConfiguredFeature<Internal.NoneFeatureConfiguration, Internal.Feature<Internal.NoneFeatureConfiguration>>>;
    ...
    class Squid3Item extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type Squid3Item_ = Squid3Item;
    class WrittenPaperItem extends Internal.Item {
    ...
    type WrittenPaperItem_ = WrittenPaperItem;
    ...
    abstract class PlatinumSuitItem extends Internal.ArmorItem {
    ...
    type PlatinumSuitItem_ = PlatinumSuitItem;
    ...
    class MagentaSaltLampBlock extends Internal.SaltLampBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    type MagentaSaltLampBlock_ = MagentaSaltLampBlock;
    ...
    type BlockPathTypes_ = "breach" | "tofucraft:unstable_tofu" | "lava" | "danger_powder_snow" | "boss_doorway" | BlockPathTypes | "unpassable_rail" | "leaves" | "cocoa" | "rail" | "fence" | "trapdoor" | "danger_fire" | "blocked" | "walkable" | "open" | "door_iron_closed" | "walkable_door" | "powder_snow" | "damage_other" | "damage_cautious" | "tofucraft:minced_tofu" | "door_wood_closed" | "door_open" | "danger_other" | "water" | "damage_fire" | "water_border" | "sticky_honey";
    ...
    class YHDanmaku$Bullet extends Internal.Enum<Internal.YHDanmaku$Bullet> {
        damage(): number;
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        get(arg0: Internal.DyeColor_): Internal.ItemEntry<Internal.DanmakuItem>;
        bypass(): boolean;
        toString(): string;
        "compareTo(dev.xkmc.youkaishomecoming.init.registrate.YHDanmaku$Bullet)"(arg0: Internal.YHDanmaku$Bullet_): number;
        static valueOf(arg0: string): Internal.YHDanmaku$Bullet;
        notifyAll(): void;
        compareTo(arg0: Internal.YHDanmaku$Bullet_): number;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        getDeclaringClass(): typeof Internal.YHDanmaku$Bullet;
        static values(): Internal.YHDanmaku$Bullet[];
        name(): string;
        hashCode(): number;
        ordinal(): number;
        wait(): void;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.YHDanmaku$Bullet>>;
        wait(arg0: number): void;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof Internal.YHDanmaku$Bullet
        readonly name: string;
        static readonly BUBBLE: (Internal.YHDanmaku$Bullet) & (Internal.YHDanmaku$Bullet);
        static readonly CIRCLE: (Internal.YHDanmaku$Bullet) & (Internal.YHDanmaku$Bullet);
        static readonly BUTTERFLY: (Internal.YHDanmaku$Bullet) & (Internal.YHDanmaku$Bullet);
        static readonly BALL: (Internal.YHDanmaku$Bullet) & (Internal.YHDanmaku$Bullet);
        readonly size: number;
        static readonly MENTOS: (Internal.YHDanmaku$Bullet) & (Internal.YHDanmaku$Bullet);
        readonly tag: Internal.TagKey<Internal.Item>;
    }
    type YHDanmaku$Bullet_ = "bubble" | "circle" | "mentos" | "ball" | YHDanmaku$Bullet | "butterfly";
    class BrewingRecipe$Serializer implements Internal.RecipeSerializer<Internal.BrewingRecipe> {
        ...
        toString(): string;
        "toNetwork(net.minecraft.network.FriendlyByteBuf,lekavar.lma.drinkbeer.recipes.BrewingRecipe)"(arg0: Internal.FriendlyByteBuf_, arg1: Internal.BrewingRecipe_): void;
        ...
        wait(arg0: number, arg1: number): void;
        fromJson(arg0: ResourceLocation_, arg1: Internal.JsonObject_): Internal.BrewingRecipe;
        ...
        "fromJson(net.minecraft.resources.ResourceLocation,com.google.gson.JsonObject)"(arg0: ResourceLocation_, arg1: Internal.JsonObject_): Internal.BrewingRecipe;
        ...
        wait(): void;
        fromJson(arg0: ResourceLocation_, arg1: Internal.JsonObject_, arg2: Internal.ICondition$IContext_): Internal.BrewingRecipe;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
    ...
    class EditBox extends Internal.AbstractWidget implements Internal.IMixinEditBox, de.keksuccino.fancymenu.mixin.mixins.common.client.IMixinEditBox, Internal.Renderable {
    ...
    class BlockShrine extends Internal.BaseEntityBlock {
        constructor()
        /**
         * @deprecated
        */
    ...
    interface IGuiCategoryUIEditorSettingData <V> {
    ...
    type IGuiCategoryUIEditorSettingData_<V> = IGuiCategoryUIEditorSettingData<V>;
    ...
    class GameRules$BooleanValue extends Internal.GameRules$Value<Internal.GameRules$BooleanValue> {
        ...
        static m_46235_(arg0: Internal.MinecraftServer_, arg1: Internal.GameRules$BooleanValue_): void;
        ...
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        static m_46240_(arg0: boolean, arg1: Internal.GameRules$Type_<any>): Internal.GameRules$BooleanValue;
        get class(): typeof any
    ...
    interface O0o00oo0OOOO000oooOo00oo <E extends Internal.o00O00OoO0OooOoOO00ooo0O<any>> {
        o0ooo0oooooooooOOO0o0OoO(): number;
        abstract o0oo000Oo000OO0O00OoOooo(arg0: string, arg1: E): Internal.ooO0oOOOooOOoooo00o00o0O;
        abstract O00oooO0oO0OoOO00oo00OoO(): Internal.oooo00O0oOoooO0o0o00oooO<E>;
        o0oo000Oo000OO0O00OoOooo(arg0: E, arg1: Internal.ooo00oooOOOO0o0o00Oo000o_<any>, arg2: Internal.oO00Ooo0Ooo0oOO0O00o0O0o_<E>): boolean;
        ooO0OOoo0oOOO0OOOo0OOooo(arg0: string): Internal.O00o0O000oo0oOOOOo0o0OoO;
    }
    type O0o00oo0OOOO000oooOo00oo_<E extends Internal.o00O00OoO0OooOoOO00ooo0O<any>> = O0o00oo0OOOO000oooOo00oo<E>;
    abstract class Interface {
        constructor(arg0: Internal.InterfaceManager_, arg1: string, arg2: number, arg3: number, arg4: number, arg5: Internal.ModOptions_)
        constructor(arg0: Internal.InterfaceManager_, arg1: string, arg2: number, arg3: number, arg4: number, arg5: number, arg6: number, arg7: Internal.ModOptions_)
        getClass(): typeof any;
        backup(): void;
        getW(arg0: number): number;
        getX(): number;
        applyPreset(arg0: xaero.common.interfaces.Preset_): void;
        getY(): number;
        getW(): number;
        restore(): void;
        ...
        setFromRight(arg0: boolean): void;
        isCentered(): boolean;
        getcBox(): Internal.CursorBox;
        setY(arg0: number): void;
        setX(arg0: number): void;
        isMulti(): boolean;
        setFlipped(arg0: boolean): void;
        setCentered(arg0: boolean): void;
        setActualx(arg0: number): void;
        createInterfaceInstance(arg0: Internal.XaeroMinimapSession_): Internal.InterfaceInstance;
        setActualy(arg0: number): void;
        toString(): string;
        notifyAll(): void;
        setFromBottom(arg0: boolean): void;
        hashCode(): number;
        getH(arg0: number): number;
        getOption(): Internal.ModOptions;
        getH(): number;
        getActualy(): number;
        isFromRight(): boolean;
        getActualx(): number;
        ...
        shouldFlip(arg0: number): boolean;
        equals(arg0: any): boolean;
        isFlipped(): boolean;
        get class(): typeof any
        get x(): number
        ...
        set h(arg0: number)
        set w(arg0: number)
        set fromRight(arg0: boolean)
        get centered(): boolean
        get cBox(): Internal.CursorBox
        set y(arg0: number)
        set x(arg0: number)
        get multi(): boolean
        set flipped(arg0: boolean)
        set centered(arg0: boolean)
        set actualx(arg0: number)
        set actualy(arg0: number)
        set fromBottom(arg0: boolean)
        get option(): Internal.ModOptions
        get h(): number
        get actualy(): number
        ...
        get flipped(): boolean
        static readonly PRESS_C_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly CENTERED_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly SPACE_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly EMPTY_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly PRESS_F_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly TRUE_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly FLIPPED_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
        static readonly FALSE_COMPONENT: (Internal.MutableComponent) & (net.minecraft.network.chat.Component);
    }
    ...
    class HybridizingRecipeType extends Internal.BlockKeyRecipeType<Internal.LycheeContext, Internal.HybridizingRecipe> {
        constructor(arg0: string, arg1: typeof Internal.HybridizingRecipe, arg2: Internal.LootContextParamSet_)
        getClass(): typeof any;
        tryMatch<D extends net.minecraft.world.Container>(arg0: Internal.Recipe_<D>, arg1: Internal.Level_, arg2: D): Internal.Optional<Internal.HybridizingRecipe>;
        process(arg0: Internal.Level_, arg1: Internal.BlockState_, arg2: Internal.Supplier_<Internal.LycheeContext>): snownee.lychee.util.Pair<Internal.LycheeContext, Internal.HybridizingRecipe>;
        buildContext(arg0: Internal.Bee_, arg1: BlockPos_, arg2: Internal.BlockState_): Internal.Supplier<Internal.LycheeContext>;
        isEmpty(): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        process(arg0: Internal.Player_, arg1: Internal.InteractionHand_, arg2: BlockPos_, arg3: Vec3d_, arg4: Internal.LycheeContext$Builder_<Internal.LycheeContext>): Internal.Optional<Internal.HybridizingRecipe>;
        static removeOverflownPollens(arg0: Internal.Bee_): void;
        inViewerRecipes(): Internal.List<Internal.HybridizingRecipe>;
        ...
        toString(): string;
        notifyAll(): void;
        onPollinateComplete(arg0: Internal.Bee_): void;
        recipes(): Internal.List<Internal.HybridizingRecipe>;
        hashCode(): number;
        blockKeysToItems(): Internal.List<Internal.ItemStack>;
        findFirst(arg0: Internal.LycheeContext_, arg1: Internal.Level_): Internal.Optional<Internal.HybridizingRecipe>;
        wait(): void;
        buildCache(): void;
        wait(arg0: number): void;
    ...
    type HybridizingRecipeType_ = HybridizingRecipeType;
    ...
    interface Floatable {
        onCollide(arg0: Internal.Level_, arg1: BlockPos_, arg2: Internal.BlockState_, arg3: Internal.BlockState_, arg4: Internal.FloatingBlockEntity_): void;
        getHurtsEntitySelector(): Internal.Predicate<Internal.Entity>;
        onBrokenAfterCollide(arg0: Internal.Level_, arg1: BlockPos_, arg2: Internal.FloatingBlockEntity_): void;
        getFallDamageSource(arg0: Internal.Entity_): DamageSource;
        get hurtsEntitySelector(): Internal.Predicate<Internal.Entity>
    }
    type Floatable_ = Floatable;
    ...
    class DataSerializerItemList$1 implements Internal.EntityDataSerializer<Internal.NonNullList<Internal.ItemStack>> {
        ...
        notify(): void;
        wait(arg0: number, arg1: number): void;
        "write(net.minecraft.network.FriendlyByteBuf,net.minecraft.core.NonNullList)"(arg0: Internal.FriendlyByteBuf_, arg1: Internal.NonNullList_<Internal.ItemStack>): void;
        ...
        wait(): void;
        "read(net.minecraft.network.FriendlyByteBuf)"(arg0: Internal.FriendlyByteBuf_): Internal.NonNullList<Internal.ItemStack>;
        "copy(net.minecraft.core.NonNullList)"(arg0: Internal.NonNullList_<Internal.ItemStack>): Internal.NonNullList<Internal.ItemStack>;
        wait(arg0: number): void;
    ...
    class LettuceCropBlock extends Internal.CropBlock {
    ...
    type LettuceCropBlock_ = LettuceCropBlock;
    class AlbumBonusDescriptionOutput {
        condition(arg0: net.minecraft.network.chat.Component_, arg1: net.minecraft.network.chat.Component_, arg2: boolean, arg3: Internal.IntermediateAlbumBonus_): void;
        getClass(): typeof any;
        notify(): void;
        list(arg0: net.minecraft.network.chat.Component_, arg1: Internal.IntermediateAlbumBonus_): void;
        wait(arg0: number, arg1: number): void;
        static getBooleanColor(arg0: boolean): Internal.ChatFormatting;
        nested(arg0: Internal.Runnable_): void;
        list(arg0: net.minecraft.network.chat.Component_, arg1: net.minecraft.network.chat.Component_, arg2: Internal.IntermediateAlbumBonus_): void;
        static createEmpty(arg0: Internal.ActionContext_): Internal.AlbumBonusDescriptionOutput;
        generic(arg0: Internal.AlbumBonusDescriptionOutput$DescriptionLabel_): void;
        "condition(net.minecraft.network.chat.Component,boolean,team.tnt.collectorsalbum.common.resource.bonus.IntermediateAlbumBonus)"(arg0: net.minecraft.network.chat.Component_, arg1: boolean, arg2: Internal.IntermediateAlbumBonus_): void;
        text(arg0: net.minecraft.network.chat.Component_): void;
        toString(): string;
        notifyAll(): void;
        condition(arg0: net.minecraft.network.chat.Component_, arg1: boolean, arg2: Internal.IntermediateAlbumBonus_): void;
        condition(arg0: net.minecraft.network.chat.Component_, arg1: net.minecraft.network.chat.Component_, arg2: Internal.IntermediateAlbumBonus_): void;
        text(arg0: net.minecraft.network.chat.Component_, arg1: net.minecraft.network.chat.Component_): void;
        "condition(net.minecraft.network.chat.Component,net.minecraft.network.chat.Component,team.tnt.collectorsalbum.common.resource.bonus.IntermediateAlbumBonus)"(arg0: net.minecraft.network.chat.Component_, arg1: net.minecraft.network.chat.Component_, arg2: Internal.IntermediateAlbumBonus_): void;
        getContext(): Internal.ActionContext;
        hashCode(): number;
        wait(): void;
        wait(arg0: number): void;
        condition(arg0: net.minecraft.network.chat.Component_, arg1: Internal.IntermediateAlbumBonus_): void;
        toComponentList(): Internal.List<Internal.AlbumBonusDescriptionOutput$ComponentWithTooltip>;
        equals(arg0: any): boolean;
        get class(): typeof any
        get context(): Internal.ActionContext
    }
    type AlbumBonusDescriptionOutput_ = AlbumBonusDescriptionOutput;
    /**
    ...
    */
    ...
    interface IFunctionalRenderer {
        abstract render(arg0: Internal.PoseStack_, arg1: Internal.VertexConsumer_, arg2: Internal.ItemDisplayContext_, arg3: number, arg4: number): void;
        (arg0: Internal.PoseStack, arg1: Internal.VertexConsumer, arg2: Internal.ItemDisplayContext, arg3: number, arg4: number): void;
    }
    type IFunctionalRenderer_ = ((arg0: Internal.PoseStack, arg1: Internal.VertexConsumer, arg2: Internal.ItemDisplayContext, arg3: number, arg4: number)=> void) | IFunctionalRenderer;
    ...
    class ItemKappaCompass extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
        ...
        */
        onDestroyed(arg0: Internal.ItemEntity_): void;
        static addPoint(arg0: Internal.Activity_, arg1: BlockPos_, arg2: Internal.ItemStack_): void;
        isFireResistant(): boolean;
        onItemUseFirst(arg0: Internal.ItemStack_, arg1: Internal.UseOnContext_): InteractionResult;
        isComplex(): boolean;
        onCraftedBy(arg0: Internal.ItemStack_, arg1: Internal.Level_, arg2: Internal.Player_): void;
        ...
        */
        ...
        getUseAnimation(arg0: Internal.ItemStack_): Internal.UseAnim;
        getDescriptionId(): string;
        static addDimension(arg0: ResourceLocation_, arg1: Internal.ItemStack_): void;
        isValidRepairItem(arg0: Internal.ItemStack_, arg1: Internal.ItemStack_): boolean;
        moonlight$getClientAnimationExtension(): any;
        getXpRepairRatio(arg0: Internal.ItemStack_): number;
        isBookEnchantable(arg0: Internal.ItemStack_, arg1: Internal.ItemStack_): boolean;
        ...
        */
        ...
        overrideStackedOnOther(arg0: Internal.ItemStack_, arg1: Internal.Slot_, arg2: Internal.ClickAction_, arg3: Internal.Player_): boolean;
        setFoodProperties(consumer: Internal.Consumer_<Internal.FoodBuilder>): void;
        static getDimension(arg0: Internal.ItemStack_): ResourceLocation;
        goldenagecombat$setMaxStackSize(arg0: number): void;
        onBlockStartBreak(arg0: Internal.ItemStack_, arg1: BlockPos_, arg2: Internal.Player_): boolean;
        getMaxDamage(arg0: Internal.ItemStack_): number;
        elytraFlightTick(arg0: Internal.ItemStack_, arg1: Internal.LivingEntity_, arg2: number): boolean;
        ...
        onStopUsing(arg0: Internal.ItemStack_, arg1: Internal.LivingEntity_, arg2: number): void;
        isNotReplaceableByPickAction(arg0: Internal.ItemStack_, arg1: Internal.Player_, arg2: number): boolean;
        static getPoint(arg0: Internal.Activity_, arg1: Internal.ItemStack_): BlockPos;
        /**
         * @deprecated
        */
        getMaxStackSize(): number;
        ...
        */
        ...
        isCorrectToolForDrops(arg0: Internal.BlockState_): boolean;
        verifyTagAfterLoad(arg0: Internal.CompoundTag_): void;
        static getRecordCount(arg0: Internal.ItemStack_): number;
        canEquip(arg0: Internal.ItemStack_, arg1: Internal.EquipmentSlot_, arg2: Internal.Entity_): boolean;
        "setFoodProperties(java.util.function.Consumer)"(consumer: Internal.Consumer_<Internal.FoodBuilder>): void;
        finishUsingItem(arg0: Internal.ItemStack_, arg1: Internal.Level_, arg2: Internal.LivingEntity_): Internal.ItemStack;
        setArmorKnockbackResistance(knockbackResistance: number): void;
        ...
        puzzleslib$getRenderProperties(): any;
        canBeDepleted(): boolean;
        static hasKappaCompassData(arg0: Internal.ItemStack_): boolean;
        initializeClient(arg0: Internal.Consumer_<Internal.IClientItemExtensions>): void;
        getDamage(arg0: Internal.ItemStack_): number;
        mineBlock(arg0: Internal.ItemStack_, arg1: Internal.Level_, arg2: Internal.BlockState_, arg3: BlockPos_, arg4: Internal.LivingEntity_): boolean;
        wait(arg0: number, arg1: number): void;
    ...
    type ItemKappaCompass_ = ItemKappaCompass;
    ...
    interface OutputBuilder <T> {
        abstract acceptAll(arg0: Internal.List_<T>): void;
        abstract accept(arg0: T): void;
    }
    type OutputBuilder_<T> = OutputBuilder<T>;
    ...
    class CookingPanBlock extends Internal.BaseEntityBlock {
        constructor(settings: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
        ...
        */
        ...
        playerDestroy(arg0: Internal.Level_, arg1: Internal.Player_, arg2: BlockPos_, arg3: Internal.BlockState_, arg4: Internal.BlockEntity_, arg5: Internal.ItemStack_): void;
        isPossibleToRespawnInThis(arg0: Internal.BlockState_): boolean;
        playerWillDestroy(level: Internal.Level_, blockPos: BlockPos_, blockState: Internal.BlockState_, player: Internal.Player_): void;
        mfix$setDelegate(registryKey: Internal.ResourceKey_<any>, holder: Internal.Holder$Reference_<any>): void;
        getCloneItemStack(arg0: Internal.BlockState_, arg1: Internal.HitResult_, arg2: Internal.BlockGetter_, arg3: BlockPos_, arg4: Internal.Player_): Internal.ItemStack;
        getClass(): typeof any;
        getMaxVerticalOffset(): number;
        ...
        */
        ...
        get mod(): string
        set hasCollision(arg0: boolean)
        static readonly DAMAGE: (Internal.IntegerProperty) & (Internal.IntegerProperty);
    ...
    type CookingPanBlock_ = CookingPanBlock;
    interface Cache <K, V> {
    ...
    class PlayerGeoPlushieBlockItem extends Internal.GeoPlushieBlockItem {
        constructor(arg0: Internal.Block_, arg1: Internal.Rarity_)
        ...
        */
        ...
        use(arg0: Internal.Level_, arg1: Internal.Player_, arg2: Internal.InteractionHand_): Internal.InteractionResultHolder<Internal.ItemStack>;
        static getBlockEntityData(arg0: Internal.ItemStack_): Internal.CompoundTag;
        createRenderer(arg0: Internal.Consumer_<any>): void;
        static goldenagecombat$getBaseAttackSpeedUUID(): Internal.UUID;
        getAllEnchantments(arg0: Internal.ItemStack_): Internal.Map<Internal.Enchantment, number>;
        wait(arg0: number): void;
        goldenagecombat$setMaxStackSize(arg0: number): void;
    ...
    type PlayerGeoPlushieBlockItem_ = PlayerGeoPlushieBlockItem;
    interface MapLike <T> {
...
declare namespace fuzs.permanentsponges.mixin.accessor {
    interface ItemAccessor {
        permanentsponges$callGetPlayerPOVHitResult(arg0: Internal.Level_, arg1: Internal.Player_, arg2: Internal.ClipContext$Fluid_): Internal.BlockHitResult;
    }
