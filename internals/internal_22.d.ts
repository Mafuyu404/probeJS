...
declare namespace Internal {
    interface BeeAccessor {
        abstract callIncrementNumCropsGrownSincePollination(): void;
        abstract callGetCropsGrownSincePollination(): number;
        abstract callIsHiveValid(): boolean;
    }
    type BeeAccessor_ = BeeAccessor;
    interface Lock {
        abstract lock(): void;
    ...
    class BabyItem extends Internal.Item {
        constructor(gender: Internal.Gender_, properties: Internal.Item$Properties_)
        ...
        */
        ...
        onDropped(stack: Internal.ItemStack_, player: Internal.Player_): boolean;
        ...
        */
        ...
        static hasBeenInvalidated(stack: Internal.ItemStack_): boolean;
        ...
        static createItem(mother: Internal.Entity_, father: Internal.Entity_, seed: number): Internal.ItemStack;
        ...
        */
        ...
        static getBabyNbt(stack: Internal.ItemStack_): Internal.CompoundTag;
    ...
    type BabyItem_ = BabyItem;
    abstract class AbstractNbtFeature <C extends Internal.FeatureConfiguration> extends Internal.Feature<C> {
    ...
    type AbstractNbtFeature_<C extends Internal.FeatureConfiguration> = AbstractNbtFeature<C>;
    ...
    class FoodBowlItem extends Internal.Item {
        ...
        */
        ...
        canEquip(arg0: Internal.ItemStack_, arg1: Internal.EquipmentSlot_, arg2: Internal.Entity_): boolean;
        "setFoodProperties(java.util.function.Consumer)"(consumer: Internal.Consumer_<Internal.FoodBuilder>): void;
        finishUsingItem(itemStack: Internal.ItemStack_, level: Internal.Level_, livingEntity: Internal.LivingEntity_): Internal.ItemStack;
        setArmorKnockbackResistance(knockbackResistance: number): void;
        setFireResistant(arg0: boolean): void;
        onInventoryTick(arg0: Internal.ItemStack_, arg1: Internal.Level_, arg2: Internal.Player_, arg3: number, arg4: number): void;
        getEatingSound(): Internal.SoundEvent;
    ...
    type FoodBowlItem_ = FoodBowlItem;
    ...
    class BlockCrushingRecipe extends Internal.LycheeRecipe<Internal.BlockCrushingContext> implements Internal.BlockKeyRecipe<Internal.BlockCrushingRecipe> {
        ...
        getRandomRepeats(arg0: number, arg1: Internal.BlockCrushingContext_): number;
        matchesFallingBlock(arg0: Internal.BlockState_, arg1: Internal.CompoundTag_): boolean;
        assemble(arg0: Internal.BlockCrushingContext_, arg1: Internal.RegistryAccess_): Internal.ItemStack;
        isSecretCondition(arg0: number): boolean;
        "assemble(snownee.lychee.block_crushing.BlockCrushingContext,net.minecraft.core.RegistryAccess)"(arg0: Internal.BlockCrushingContext_, arg1: Internal.RegistryAccess_): Internal.ItemStack;
        notify(): void;
        ...
        isSpecial(): boolean;
        "compareTo(snownee.lychee.block_crushing.BlockCrushingRecipe)"(arg0: Internal.BlockCrushingRecipe_): number;
        "matches(snownee.lychee.block_crushing.BlockCrushingContext,net.minecraft.world.level.Level)"(arg0: Internal.BlockCrushingContext_, arg1: Internal.Level_): boolean;
        ...
        tickOrApply(arg0: Internal.BlockCrushingContext_): boolean;
        ...
        get "type()"(): ResourceLocation
        get "serializer()"(): Internal.LycheeRecipe$Serializer<any>
        static readonly ANVIL: (net.minecraft.advancements.critereon.BlockPredicate) & (net.minecraft.advancements.critereon.BlockPredicate);
    }
    ...
    class ChatComponent {
        ...
        getClass(): typeof any;
        localvar$zjb000$chatheads$captureGuiMessage(guiMessage: Internal.GuiMessage$Line_, guiMessageRef: Internal.LocalRef_<any>, chatOffsetRef: Internal.LocalIntRef_): Internal.GuiMessage$Line;
        handler$zjb000$chatheads$renderChatHead(guiGraphics: Internal.GuiGraphics_, i: number, j: number, k: number, ci: Internal.CallbackInfo_, guiMessage: Internal.LocalRef_<any>, yRef: Internal.LocalIntRef_, opacityRef: Internal.LocalFloatRef_): void;
        static defaultUnfocusedPct(): number;
        modifyExpressionValue$zjb000$chatheads$fixTextOverflow(original: number): number;
        localvar$zcg000$addMessage(arg0: net.minecraft.network.chat.Component_): net.minecraft.network.chat.Component;
        notify(): void;
        modify$zjb000$chatheads$moveText(font: net.minecraft.client.gui.Font_, formattedCharSequence: Internal.FormattedCharSequence_, x: number, y: number, color: number, chatOffsetRef: Internal.LocalIntRef_, yRef: Internal.LocalIntRef_, opacityRef: Internal.LocalFloatRef_): number;
        wait(arg0: number, arg1: number): void;
        getLinesPerPage(): number;
        getClickedComponentStyleAt(arg0: number, arg1: number): Internal.Style;
        constant$dek000$placebo_unEscapeChatLogNewlines(arg0: string): string;
        modify$zjb000$chatheads$correctClickPosition(x: number, chatOffsetRef: Internal.LocalIntRef_): number;
        ...
        notifyAll(): void;
        localvar$zjb000$chatheads$updateChatOffset(guiMessage: Internal.GuiMessage$Line_, chatOffsetRef: Internal.LocalIntRef_): Internal.GuiMessage$Line;
        rescaleChat(): void;
        getScale(): number;
    ...
    class Village implements Internal.Iterable<Internal.Building> {
        constructor(v: Internal.CompoundTag_, world: Internal.ServerLevel_)
        constructor(id: number, world: Internal.ServerLevel_)
        setPopulationThreshold(populationThreshold: number): void;
        pushMood(m: number): void;
        removeBuilding(id: number): void;
        static findNearest(entity: Internal.Entity_): Internal.Optional<Internal.Village>;
        notify(): void;
        setAutoScan(autoScan: boolean): void;
        isVillage(): boolean;
        setName(name: string): void;
        getReputation(player: Internal.Player_): number;
        getVillageGuardsManager(): Internal.VillageGuardsManager;
        resetHearts(player: Internal.Player_): void;
        getResidentNames(): Internal.Map<Internal.UUID, string>;
        "pushHearts(net.minecraft.world.entity.player.Player,int)"(player: Internal.Player_, rep: number): void;
        markDirty(): void;
        pushHearts(player: Internal.UUID_, rep: number): void;
        iterator(): Internal.Iterator<Internal.Building>;
        calculateDimensions(): void;
        updateResident(e: Internal.VillagerEntityMCA_): void;
        getBuilding(id: number): Internal.Optional<Internal.Building>;
        getBox(): Internal.BlockBoxExtended;
        wait(): void;
        merge(village: Internal.Village_): void;
        isWithinBorder(pos: BlockPos_, margin: number): boolean;
        "removeResident(forge.net.mca.entity.VillagerEntityMCA)"(villager: Internal.VillagerEntityMCA_): void;
        isWithinBorder(entity: Internal.Entity_): boolean;
        setMarriageThreshold(marriageThreshold: number): void;
        updateMaxPopulation(): void;
        getClass(): typeof any;
        hasSpace(): boolean;
        hasResident(id: Internal.UUID_): boolean;
        "pushHearts(java.util.UUID,int)"(player: Internal.UUID_, rep: number): void;
        popHearts(player: Internal.Player_): number;
        cleanReputation(): void;
        getPopulationThreshold(): number;
        getCivilRegistry(): Internal.Optional<Internal.CivilRegistryManager>;
        spliterator(): Internal.Spliterator<Internal.Building>;
        getResidents(world: Internal.ServerLevel_): Internal.List<Internal.VillagerEntityMCA>;
        wait(arg0: number, arg1: number): void;
        isPositionValidBed(pos: BlockPos_): boolean;
        getResidents(building: number): Internal.List<string>;
        broadCastMessage(world: Internal.ServerLevel_, event: string, targetName: string): void;
        getBuildingAt(pos: Vec3i_): Internal.Optional<Internal.Building>;
        getCenter(): Vec3i;
        "getResidents(net.minecraft.server.level.ServerLevel)"(world: Internal.ServerLevel_): Internal.List<Internal.VillagerEntityMCA>;
        onEnter(world: Internal.ServerLevel_): void;
        getName(): string;
        setReputation(player: Internal.Player_, villager: Internal.VillagerEntityMCA_, rep: number): void;
        isAutoScan(): boolean;
        pushHearts(player: Internal.Player_, rep: number): void;
        getTaxes(): number;
        forEach(arg0: Internal.Consumer_<Internal.Building>): void;
        setTaxes(taxes: number): void;
        getId(): number;
        save(): Internal.CompoundTag;
        getBuildings(): Internal.Map<number, Internal.Building>;
        getBuildingsOfType(type: string): Internal.Stream<Internal.Building>;
        getMarriageThreshold(): number;
        broadCastMessage(world: Internal.ServerLevel_, event: string, suitor: Internal.VillagerEntityMCA_, mate: Internal.VillagerEntityMCA_): void;
        getMaxPopulation(): number;
        toString(): string;
        notifyAll(): void;
        "getResidents(int)"(building: number): Internal.List<string>;
        getPopulation(): number;
        tick(world: Internal.ServerLevel_, time: number): void;
        hasBuilding(building: string): boolean;
        toggleAutoScan(): void;
        popMood(): number;
        hashCode(): number;
        getResidentsUUIDs(): Internal.Stream<Internal.UUID>;
        wait(arg0: number): void;
        "removeResident(java.util.UUID)"(uuid: Internal.UUID_): void;
        hasStoredResource(): boolean;
        equals(arg0: any): boolean;
        removeResident(villager: Internal.VillagerEntityMCA_): void;
        removeResident(uuid: Internal.UUID_): void;
        set populationThreshold(populationThreshold: number)
        set autoScan(autoScan: boolean)
        get village(): boolean
        set name(name: string)
        get villageGuardsManager(): Internal.VillageGuardsManager
        get residentNames(): Internal.Map<Internal.UUID, string>
        get box(): Internal.BlockBoxExtended
        set marriageThreshold(marriageThreshold: number)
        get class(): typeof any
        get populationThreshold(): number
        get civilRegistry(): Internal.Optional<Internal.CivilRegistryManager>
        get center(): Vec3i
        get name(): string
        ...
        get id(): number
        get buildings(): Internal.Map<number, Internal.Building>
        get marriageThreshold(): number
        get maxPopulation(): number
        get population(): number
        get residentsUUIDs(): Internal.Stream<Internal.UUID>
        static readonly PLAYER_BORDER_MARGIN: (32) & (number);
        readonly storageBuffer: Internal.List<Internal.ItemStack>;
        static readonly BORDER_MARGIN: (48) & (number);
        static readonly MERGE_MARGIN: (64) & (number);
        lastMoveIn: number;
    }
    type Village_ = Village;
    class AetherDirtPathBlock extends Internal.DirtPathBlock {
        constructor(arg0: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
    ...
    type AetherDirtPathBlock_ = AetherDirtPathBlock;
    ...
    class RunicSwordItem extends Internal.SwordItem {
        ...
        */
        ...
        isFireResistant(): boolean;
        onItemUseFirst(arg0: Internal.ItemStack_, arg1: Internal.UseOnContext_): InteractionResult;
        onCraftedBy(stack: Internal.ItemStack_, world: Internal.Level_, player: Internal.Player_): void;
        isComplex(): boolean;
        isPiglinCurrency(arg0: Internal.ItemStack_): boolean;
        isCorrectToolForDrops(arg0: Internal.ItemStack_, arg1: Internal.BlockState_): boolean;
        getEnchantmentValue(arg0: Internal.ItemStack_): number;
    ...
    interface IPlayerTrackerSystem <P> {
    ...
    class AetherLakeConfiguration extends Internal.Record implements Internal.FeatureConfiguration {
        constructor(fluid: Internal.BlockStateProvider_, top: Internal.BlockStateProvider_)
        getClass(): typeof any;
        hashCode(): number;
        ...
        notifyAll(): void;
        wait(arg0: number): void;
        top(): Internal.BlockStateProvider;
        ...
        static readonly CODEC: Internal.Codec<Internal.AetherLakeConfiguration>;
    }
    type AetherLakeConfiguration_ = AetherLakeConfiguration;
    class Dimensions extends Internal.Record {
    ...
    class ChatText {
        constructor(arg0: any_, arg1: ResourceLocation_, arg2: string)
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        getText(): string;
        ...
        wait(): void;
        wait(arg0: number): void;
        getIconPath(): ResourceLocation;
        static fromBuff(arg0: Internal.FriendlyByteBuf_): Internal.ChatText;
        equals(arg0: any): boolean;
        isText(): boolean;
        static toBuff(arg0: Internal.ChatText_, arg1: Internal.FriendlyByteBuf_): void;
        get class(): typeof any
        get text(): string
        get icon(): boolean
        get iconPath(): ResourceLocation
        get text(): boolean
        static readonly EMPTY_CHAT_TEXT: (Internal.ChatText) & (Internal.ChatText);
        static readonly EMPTY_ICON_PATH: (ResourceLocation) & (ResourceLocation);
    }
    type ChatText_ = ChatText;
    ...
    class ForgeGui extends Internal.Gui {
        constructor(arg0: Internal.Minecraft_)
        handler$dnk000$renderPlacementAssistMarker(gui: Internal.GuiGraphics_, ci: Internal.CallbackInfo_): void;
        getMinecraft(): Internal.Minecraft;
        renderSelectedItemName(arg0: Internal.GuiGraphics_): void;
        notify(): void;
        handler$ffp000$disableForgeTpsGraph(ci: Internal.CallbackInfo_): void;
        ...
        onDisconnected(): void;
        handler$bgf000$iris$handleHudHidingScreens(pGui0: Internal.GuiGraphics_, pFloat1: number, ci: Internal.CallbackInfo_): void;
        handler$ffp000$customDebugMenu(width: number, height: number, guiGraphics: Internal.GuiGraphics_, ci: Internal.CallbackInfo_): void;
        ...
        getClass(): typeof any;
        handler$bgg001$iris$handleHudHidingScreens(pGui0: Internal.GuiGraphics_, pFloat1: number, ci: Internal.CallbackInfo_): void;
        ...
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        handler$ffo005$init(info: Internal.CallbackInfo_): void;
    ...
    class ChiliCropsBlock extends Internal.CropBlock {
        constructor(arg0: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
    ...
    type ChiliCropsBlock_ = ChiliCropsBlock;
    class CursorBox {
    ...
    class SunflowerSeedItem extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type SunflowerSeedItem_ = SunflowerSeedItem;
    abstract class OO0OOOO00oOOO0O0OooOOoOO <T> {
        constructor(arg0: T, arg1: number, arg2: Internal.O0oOo00000o0oOoOOo0OoOOo_<any>)
        getClass(): typeof any;
    ...
    type OO0OOOO00oOOO0O0OooOOoOO_<T> = OO0OOOO00oOOO0O0OooOOoOO<T>;
    class CoffeeMokaPot extends Internal.CoffeePotBase {
        constructor()
        /**
         * @deprecated
        */
    ...
    type CoffeeMokaPot_ = CoffeeMokaPot;
    ...
    class PhilosopherStone extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type PhilosopherStone_ = PhilosopherStone;
    interface CancellableEventHandler$CancellableFunctionOnlyReturn <T> {
        abstract apply(arg0: T): boolean;
        (arg0: T): boolean;
    }
    type CancellableEventHandler$CancellableFunctionOnlyReturn_<T> = CancellableEventHandler$CancellableFunctionOnlyReturn<T> | ((arg0: T)=> boolean);
    ...
    class HoneyCake extends Internal.CakeBlock {
        constructor()
    ...
    class BlockDreadBase extends Internal.BlockGeneric implements Internal.IDragonProof, Internal.IDreadBlock {
        constructor(arg0: Internal.BlockBehaviour$Properties_)
        /**
         * @deprecated
        */
        ...
        */
        ...
        getJumpFactor(): number;
        isValidSpawn(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.SpawnPlacements$Type_, arg4: Internal.EntityType_<any>): boolean;
        static builder(arg0: number, arg1: number, arg2: SoundType_, arg3: Internal.MapColor_, arg4: Internal.NoteBlockInstrument_, arg5: boolean): Internal.BlockDreadBase;
        getFlammability(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Direction_): number;
        static canSupportCenter(arg0: Internal.LevelReader_, arg1: BlockPos_, arg2: Internal.Direction_): boolean;
        /**
         * @deprecated
    ...
    type BlockDreadBase_ = BlockDreadBase;
    class GenericKeyEvent extends net.minecraftforge.eventbus.api.Event {
        constructor()
        constructor(arg0: Internal.Predicate_<Internal.InputConstants$Key>, arg1: number)
        getResult(): Internal.Event$Result;
        setCanceled(arg0: boolean): void;
        getClass(): typeof any;
        toString(): string;
        ...
        notifyAll(): void;
        isCanceled(): boolean;
        test(arg0: Internal.InputConstants$Key_): boolean;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hasResult(): boolean;
        setResult(arg0: Internal.Event$Result_): void;
    ...
    type GenericKeyEvent_ = GenericKeyEvent;
    ...
    class RecipeNamespace extends Internal.LinkedHashMap<string, Internal.RecipeSchemaType> {
        ...
        pollFirstEntry(): Internal.Map$Entry<string, Internal.RecipeSchemaType>;
        ...
        sequencedValues(): Internal.SequencedCollection<Internal.RecipeSchemaType>;
        ...
        lastEntry(): Internal.Map$Entry<string, Internal.RecipeSchemaType>;
        notify(): void;
        replace(arg0: string, arg1: Internal.RecipeSchemaType_, arg2: Internal.RecipeSchemaType_): boolean;
        static of<K, V>(arg0: K, arg1: V, arg2: K, arg3: V, arg4: K, arg5: V): Internal.Map<K, V>;
        static copyOf<K, V>(arg0: Internal.Map_<K, V>): Internal.Map<K, V>;
        pollLastEntry(): Internal.Map$Entry<string, Internal.RecipeSchemaType>;
        static of<K, V>(arg0: K, arg1: V, arg2: K, arg3: V, arg4: K, arg5: V, arg6: K, arg7: V, arg8: K, arg9: V, arg10: K, arg11: V): Internal.Map<K, V>;
        put(arg0: string, arg1: Internal.RecipeSchemaType_): Internal.RecipeSchemaType;
        reversed(): Internal.SequencedMap<string, Internal.RecipeSchemaType>;
        ...
        clone(): any;
        getClass(): typeof any;
        putLast(arg0: string, arg1: Internal.RecipeSchemaType_): Internal.RecipeSchemaType;
        keySet(): Internal.Set<string>;
        static of<K, V>(): Internal.Map<K, V>;
        firstEntry(): Internal.Map$Entry<string, Internal.RecipeSchemaType>;
        putFirst(arg0: string, arg1: Internal.RecipeSchemaType_): Internal.RecipeSchemaType;
        isEmpty(): boolean;
        ...
        sequencedEntrySet(): Internal.SequencedSet<Internal.Map$Entry<string, Internal.RecipeSchemaType>>;
        ...
        remove(arg0: any): Internal.RecipeSchemaType;
        static of<K, V>(arg0: K, arg1: V, arg2: K, arg3: V, arg4: K, arg5: V, arg6: K, arg7: V, arg8: K, arg9: V, arg10: K, arg11: V, arg12: K, arg13: V, arg14: K, arg15: V): Internal.Map<K, V>;
        sequencedKeySet(): Internal.SequencedSet<string>;
        size(): number;
        abstract hashCode(): number;
        static of<K, V>(arg0: K, arg1: V, arg2: K, arg3: V, arg4: K, arg5: V, arg6: K, arg7: V, arg8: K, arg9: V, arg10: K, arg11: V, arg12: K, arg13: V, arg14: K, arg15: V, arg16: K, arg17: V, arg18: K, arg19: V): Internal.Map<K, V>;
        register(id: string, type: Internal.RecipeSchema_): this;
        putAll(arg0: Internal.Map_<string, Internal.RecipeSchemaType>): void;
    ...
    class CrushedBirdiseyechiliItem extends Internal.Item {
        constructor()
        getDrinkingSound(): Internal.SoundEvent;
        getShareTag(arg0: Internal.ItemStack_): Internal.CompoundTag;
        setRarity(arg0: Internal.Rarity_): void;
    ...
    type CrushedBirdiseyechiliItem_ = CrushedBirdiseyechiliItem;
    /**
    ...
    */
    ...
    abstract class O0O00O0oo00ooooOoO0oOOO0 <T> {
        constructor()
        getClass(): typeof any;
        abstract "o0oo000Oo000OO0O00OoOooo(java.lang.Object)"(arg0: T): ResourceLocation;
        abstract o0oo000Oo000OO0O00OoOooo(arg0: T): ResourceLocation;
        o0ooo0oooooooooOOO0o0OoO(arg0: T): Internal.ooOOooOOO000o0oO00O0O000;
        toString(): string;
        abstract ooO0OOoo0oOOO0OOOo0OOooo(arg0: T): string;
        abstract o0oo000Oo000OO0O00OoOooo(arg0: string): Internal.o00o0o0O0Ooooo0ooO00oooO;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        hashCode(): number;
        abstract "o0oo000Oo000OO0O00OoOooo(java.lang.String)"(arg0: string): Internal.o00o0o0O0Ooooo0ooO00oooO;
        wait(): void;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        get class(): typeof any
        ooO0OOoo0oOOO0OOOo0OOooo: number;
        o0ooo0oooooooooOOO0o0OoO: boolean;
        o0oo000Oo000OO0O00OoOooo: number;
    }
    type O0O00O0oo00ooooOoO0oOOO0_<T> = O0O00O0oo00ooooOoO0oOOO0<T>;
    interface Vector2ic {
    ...
    class CommonVertexAttribute extends Internal.Enum<Internal.CommonVertexAttribute> implements Internal.CommonVertexAttributeAccessor {
        ...
        compareTo(arg0: any): number;
        name(): string;
        static createCommonVertexElement_$md$3ae8d1$0(arg0: string, arg1: number, arg2: Internal.VertexFormatElement_): Internal.CommonVertexAttribute;
        hashCode(): number;
    ...
    class ObjectAnimation$PlayType extends Internal.Enum<Internal.ObjectAnimation$PlayType> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        static values(): Internal.ObjectAnimation$PlayType[];
        toString(): string;
        notifyAll(): void;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.ObjectAnimation$PlayType>>;
        hashCode(): number;
        "compareTo(com.tacz.guns.api.client.animation.ObjectAnimation$PlayType)"(arg0: Internal.ObjectAnimation$PlayType_): number;
        ordinal(): number;
        wait(): void;
        static valueOf(arg0: string): Internal.ObjectAnimation$PlayType;
        wait(arg0: number): void;
        getDeclaringClass(): typeof Internal.ObjectAnimation$PlayType;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        compareTo(arg0: Internal.ObjectAnimation$PlayType_): number;
        get class(): typeof any
        get declaringClass(): typeof Internal.ObjectAnimation$PlayType
        static readonly LOOP: (Internal.ObjectAnimation$PlayType) & (Internal.ObjectAnimation$PlayType);
        static readonly PLAY_ONCE_STOP: (Internal.ObjectAnimation$PlayType) & (Internal.ObjectAnimation$PlayType);
        static readonly PLAY_ONCE_HOLD: (Internal.ObjectAnimation$PlayType) & (Internal.ObjectAnimation$PlayType);
    }
    type ObjectAnimation$PlayType_ = "play_once_stop" | "play_once_hold" | "loop" | ObjectAnimation$PlayType;
    ...
    class Traits {
        ...
        getClass(): typeof any;
        addTrait(trait: Internal.Traits$Trait_): void;
        getTraits(): Internal.Set<Internal.Traits$Trait>;
        static registerTrait(id: string, chance: number, inherit: number): Internal.Traits$Trait;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        eitherHaveTrait(trait: Internal.Traits$Trait_, other: Internal.VillagerLike_<any>): boolean;
        hasTrait(trait: string): boolean;
        hasSameTrait(trait: Internal.Traits$Trait_, other: Internal.VillagerLike_<any>): boolean;
        inherit(from: Internal.Traits_): void;
        inherit(from: Internal.Traits_, seed: number): void;
        "hasTrait(forge.net.mca.entity.ai.Traits$Trait)"(trait: Internal.Traits$Trait_): boolean;
        "hasTrait(java.lang.String)"(trait: string): boolean;
        hasTrait(target: Internal.VillagerLike_<any>, trait: Internal.Traits$Trait_): boolean;
        toString(): string;
        getVerticalScaleFactor(): number;
        notifyAll(): void;
        getHorizontalScaleFactor(): number;
        static registerTrait(id: string, chance: number, inherit: number, usableOnPlayer: boolean): Internal.Traits$Trait;
        hashCode(): number;
        randomize(): void;
        wait(): void;
        ...
        wait(arg0: number): void;
        removeTrait(trait: Internal.Traits$Trait_): void;
        equals(arg0: any): boolean;
        getInheritedTraits(): Internal.Set<Internal.Traits$Trait>;
        hasTrait(trait: Internal.Traits$Trait_): boolean;
        get class(): typeof any
        get traits(): Internal.Set<Internal.Traits$Trait>
        get verticalScaleFactor(): number
        get horizontalScaleFactor(): number
        get inheritedTraits(): Internal.Set<Internal.Traits$Trait>
        static UNKNOWN: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static WEAK: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static BISEXUAL: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static ALBINISM: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static LACTOSE_INTOLERANCE: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static LEFT_HANDED: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static SIRBEN: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static VEGETARIAN: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static COLOR_BLIND: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static HETEROCHROMIA: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static readonly TRAIT_REGISTRY: ({"SIRBEN": Internal.Traits$Trait, "RAINBOW": Internal.Traits$Trait, "DIABETES": Internal.Traits$Trait, "HOMOSEXUAL": Internal.Traits$Trait, "ALBINISM": Internal.Traits$Trait, "LEFT_HANDED": Internal.Traits$Trait, "COLOR_BLIND": Internal.Traits$Trait, "LACTOSE_INTOLERANCE": Internal.Traits$Trait, "BISEXUAL": Internal.Traits$Trait, "VEGETARIAN": Internal.Traits$Trait, "WEAK": Internal.Traits$Trait, "HETEROCHROMIA": Internal.Traits$Trait, "ELECTRIFIED": Internal.Traits$Trait, "COELIAC_DISEASE": Internal.Traits$Trait, "UNKNOWN": Internal.Traits$Trait, "DWARFISM": Internal.Traits$Trait, "TOUGH": Internal.Traits$Trait}) & (Internal.Map<string, Internal.Traits$Trait>);
        static DIABETES: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static ELECTRIFIED: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static DWARFISM: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static TOUGH: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static HOMOSEXUAL: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static RAINBOW: (Internal.Traits$Trait) & (Internal.Traits$Trait);
        static COELIAC_DISEASE: (Internal.Traits$Trait) & (Internal.Traits$Trait);
    }
    type Traits_ = Traits;
    class BombEntity$BreakingMode extends Internal.Enum<Internal.BombEntity$BreakingMode> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.BombEntity$BreakingMode>>;
        getClass(): typeof any;
        toString(): string;
        notifyAll(): void;
        notify(): void;
    ...
    class CookBookBlock extends Internal.CBBlock {
        constructor()
        /**
         * @deprecated
        */
        ...
        */
        getDestroyProgress(arg0: Internal.BlockState_, arg1: Internal.Player_, arg2: Internal.BlockGetter_, arg3: BlockPos_): number;
        makesOpenTrapdoorAboveClimbable(arg0: Internal.BlockState_, arg1: Internal.LevelReader_, arg2: BlockPos_, arg3: Internal.BlockState_): boolean;
        static cookCheck(arg0: Internal.Level_, arg1: BlockPos_): void;
        /**
         * @deprecated
        */
        updateShape(arg0: Internal.BlockState_, arg1: Internal.Direction_, arg2: Internal.BlockState_, arg3: Internal.LevelAccessor_, arg4: BlockPos_, arg5: BlockPos_): Internal.BlockState;
        ...
        getLightEmission(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_): number;
        setBedOccupied(arg0: Internal.BlockState_, arg1: Internal.Level_, arg2: BlockPos_, arg3: Internal.LivingEntity_, arg4: boolean): void;
        static checkBelowBlock(arg0: Internal.Level_, arg1: BlockPos_): void;
        arch$registryName(): ResourceLocation;
        getBlockBuilder(): Internal.BlockBuilder;
        getIdLocation(): ResourceLocation;
        canDropFromExplosion(arg0: Internal.BlockState_, arg1: Internal.BlockGetter_, arg2: BlockPos_, arg3: Internal.Explosion_): boolean;
    ...
    type CookBookBlock_ = CookBookBlock;
    class FallenRelic$RelicType extends Internal.Enum<Internal.FallenRelic$RelicType> implements Internal.StringRepresentable {
        getDeclaringClass(): typeof Internal.FallenRelic$RelicType;
        getClass(): typeof any;
        ...
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        static values(): Internal.FallenRelic$RelicType[];
        static fromEnum<E extends Internal.Enum<E> & Internal.StringRepresentable>(arg0: Internal.Supplier_<E[]>): Internal.StringRepresentable$EnumCodec<E>;
        static valueOf(arg0: string): Internal.FallenRelic$RelicType;
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<Internal.FallenRelic$RelicType>>;
        toString(): string;
        notifyAll(): void;
        name(): string;
        "compareTo(org.mineplugin.locusazzurro.icaruswings.common.item.FallenRelic$RelicType)"(arg0: Internal.FallenRelic$RelicType_): number;
        hashCode(): number;
        static keys(arg0: Internal.StringRepresentable_[]): Internal.Keyable;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        compareTo(arg0: Internal.FallenRelic$RelicType_): number;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get declaringClass(): typeof Internal.FallenRelic$RelicType
        get class(): typeof any
        get serializedName(): string
        get upgraded(): boolean
        static readonly INTERFACE: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
        static readonly SECOND_GEN_CORE: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
        static readonly DEFENSIVE: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
        static readonly CORE: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
        static readonly OFFENSIVE: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
        static readonly PROPULSION: (Internal.FallenRelic$RelicType) & (Internal.FallenRelic$RelicType);
    }
    type FallenRelic$RelicType_ = "offensive" | "second_gen_core" | "propulsion" | FallenRelic$RelicType | "defensive" | "interface" | "core";
    ...
    interface OOOoo0O0000O0oOOoooO0o00 {
        abstract evaluate(arg0: Internal.oo0OooOOo0oOOO00O00oooO0_<any>, arg1: Internal.OOOoo0O0000O0oOOoooO0o00$o0oo000Oo000OO0O00OoOooo_): any;
        o0oo000Oo000OO0O00OoOooo(arg0: number): boolean;
        (arg0: Internal.oo0OooOOo0oOOO00O00oooO0<any>, arg1: Internal.OOOoo0O0000O0oOOoooO0o00$o0oo000Oo000OO0O00OoOooo): any;
        readonly o0oo000Oo000OO0O00OoOooo: (Internal.OOOoo0O0000O0oOOoooO0o00$o0oo000Oo000OO0O00OoOooo) & (Internal.OOOoo0O0000O0oOOoooO0o00$o0oo000Oo000OO0O00OoOooo);
    }
    type OOOoo0O0000O0oOOoooO0o00_ = ((arg0: Internal.oo0OooOOo0oOOO00O00oooO0<any>, arg1: Internal.OOOoo0O0000O0oOOoooO0o00$o0oo000Oo000OO0O00OoOooo)=> any) | OOOoo0O0000O0oOOoooO0o00;
    ...
    class GunFireEvent extends net.minecraftforge.eventbus.api.Event {
        constructor()
    ...
    class CaveSettings {
        constructor(entranceCaveProbability: number, cheeseCaveDepthOffset: number, cheeseCaveProbability: number, spaghettiCaveProbability: number, noodleCaveProbability: number, caveCarverProbability: number, deepCaveCarverProbability: number, ravineProbability: number, largeOreVeins: boolean, legacyCarverDistribution: boolean)
        getClass(): typeof any;
        hashCode(): number;
        toString(): string;
        wait(): void;
        ...
        wait(arg0: number, arg1: number): void;
        get class(): typeof any
        static readonly CODEC: Internal.Codec<Internal.CaveSettings>;
        caveCarverProbability: number;
        largeOreVeins: boolean;
        cheeseCaveDepthOffset: number;
        spaghettiCaveProbability: number;
        entranceCaveProbability: number;
        ravineCarverProbability: number;
        noodleCaveProbability: number;
        cheeseCaveProbability: number;
        minCaveBiomeDepth: boolean;
        deepCaveCarverProbability: number;
        legacyCarverDistribution: boolean;
    }
    type CaveSettings_ = CaveSettings;
    interface Member {
    ...
    abstract class AbstractButton extends Internal.AbstractWidget {
        ...
        handler$eij000$onClickHead(arg0: number, arg1: number, arg2: Internal.CallbackInfo_): void;
        wait(arg0: number): void;
    ...
    interface IChampion {
        abstract getClient(): Internal.IChampion$Client;
        abstract getServer(): Internal.IChampion$Server;
        abstract getLivingEntity(): Internal.LivingEntity;
        get client(): Internal.IChampion$Client
        get server(): Internal.IChampion$Server
        get livingEntity(): Internal.LivingEntity
    }
    type IChampion_ = IChampion;
