...
declare namespace Registry {
    ...
    class AlbumBonus extends Internal.RegistryEventJS<any> {
    }
    class CardType extends Internal.RegistryEventJS<any> {
    }
    class Category extends Internal.RegistryEventJS<any> {
    }
    class ItemDropProvider extends Internal.RegistryEventJS<any> {
    }
    class NumberProvider extends Internal.RegistryEventJS<any> {
    }
    class Menu extends Internal.RegistryEventJS<any> {
    }
    ...
    class FruitType extends Internal.RegistryEventJS<any> {
    }
    ...
    class WorldgenChanceModifierType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenCurveFunctionType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenDomainType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenNoiseType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenStructureRuleType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenTemplateDecoratorType extends Internal.RegistryEventJS<any> {
    }
    class WorldgenTemplatePlacementType extends Internal.RegistryEventJS<any> {
    }
    class BiomeHeight extends Internal.RegistryEventJS<any> {
    }
    ...
    class WorldgenStructureRule extends Internal.RegistryEventJS<any> {
    }
    class WorldgenNoise extends Internal.RegistryEventJS<any> {
    }
    class LunarDimensionSettings extends Internal.RegistryEventJS<any> {
    }
    class WorldgenPreset extends Internal.RegistryEventJS<any> {
    }
